import { IVpc, Port, SecurityGroup, Vpc } from "@aws-cdk/aws-ec2";
import { DockerImageAsset } from "@aws-cdk/aws-ecr-assets";
import { AsgCapacityProvider, AwsLogDriver, Cluster, ContainerImage, Ec2Service, Ec2TaskDefinition, FargateService, FargateTaskDefinition, Protocol, Scope, Secret } from "@aws-cdk/aws-ecs";
...
export class EcsFargateService extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, props: ConstructProps) {
    ...
    if (props.services?.efs) {
      props.services.efs.securityGroup.addIngressRule(this.securityGroup, Port.tcp(2049));
    ...
    this.service = new FargateService(this, "Service", {
      ...
      capacityProviderStrategies: [
        { capacityProvider: "FARGATE", base: 0, weight: 2 },
